package com.intersala.connectfour;
...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        menuBar.prefWidthProperty().bind((ObservableValue<? extends Number>) primaryStage.widthProperty());
    ...
    private void aboutMe() {
        ...
        alert.setHeaderText("Komal Singh");
